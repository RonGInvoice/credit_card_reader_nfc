...
sealed class AbstractNfcHandler(val result: MethodChannel.Result, val call: MethodCall) : NfcAdapter.ReaderCallback {
    protected fun unregister() = CreditCardReaderNfcFlutterPlugin.listeners.remove(this)
}

class Reader(result: MethodChannel.Result, call: MethodCall) : AbstractNfcHandler(result, call) {
